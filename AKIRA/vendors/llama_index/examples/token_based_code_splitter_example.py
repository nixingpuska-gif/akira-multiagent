...
"""
    ...
    char_splitter = CodeSplitter(
        language="python", count_mode="char", max_chars=60
    )
    char_chunks = char_splitter.split_text(test_code)

    # Token-based splitting
    token_splitter = CodeSplitter(
        language="python", count_mode="token", max_tokens=15
    )
...
def main():
    ...
    if not HAS_DEPENDENCIES:
        ...
        print(
            "Please install tree_sitter_language_pack and llama_index packages"
        )
        return
